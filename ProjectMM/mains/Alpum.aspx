<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alpum.aspx.cs" Inherits="ProjectMM.mains.Alpum" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <nav>
            <ul class="box-primary-nav">
                ...
                <li><a href="Alpum.aspx">Album</a></li> <i class="ion-ios-circle-filled color"></i></li>
    ...
    <div class="top-bar">
        <h1>Album</h1>
        <p><a href="main.aspx">Home</a> / Album</p>
    </div>
    <!-- end Top bar -->
