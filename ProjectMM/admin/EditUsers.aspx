<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUsers.aspx.cs" Inherits="ProjectMM.admin.EditUsers" %>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="nav nav-stacked" style="width: 249px">
                ...
                <li class="auto-style1"><strong>Edit Users<br />
                    </strong></li>
                <li class="auto-style2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="UId" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" Height="215px" Width="375px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Users] WHERE [UId] = @UId" InsertCommand="INSERT INTO [Users] ([UserName], [Password], [UserType], [Email]) VALUES (@UserName, @Password, @UserType, @Email)" SelectCommand="SELECT * FROM [Users]" UpdateCommand="UPDATE [Users] SET [UserName] = @UserName, [Password] = @Password, [UserType] = @UserType, [Email] = @Email WHERE [UId] = @UId">
                        <DeleteParameters>
